...
IngredientId int not null, 
primary key (AllergyName, IngredientId), 
FOREIGN KEY (IngredientId) REFERENCES Ingredients (Id) on update cascade on delete cascade
);
-- ^Created by Anthony^
...
-- Created by Anthony
insert into Allergens (AllergyName, IngredientId) values ('Soy', 8);
insert into Allergens (AllergyName, IngredientId) values ('Gluten', 14);
insert into Allergens (AllergyName, IngredientId) values ('Lactose', 6);
insert into Allergens (AllergyName, IngredientId) values ('Lactose', 9);
-- ^Created by Anthony^
